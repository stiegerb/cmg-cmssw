...
case $WHAT in
    PLOTS )
		...
		# python mcPlots.py ${options} --print-dir ${outdir}/norm/ mca-2lss-data_thq_forplotting.txt bins/2lss_thq_${chan}.txt bins/THq_LD_inputs_plots.txt -U presel_thq --xp data --xp QF_data,ttG.* --plotmode norm
