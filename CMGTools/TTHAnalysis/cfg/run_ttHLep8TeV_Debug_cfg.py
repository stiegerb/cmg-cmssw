...
# Event Analyzer (debugging)
ttHEventAnaDebug = cfg.Analyzer(
    'ttHLepEventAnalyzerDebug',
    maxLeps = 4, ## leptons to use
    verbose = False,
    )

# Lepton Analyzer (debugging)
ttHLepAnaDebug = cfg.Analyzer(
    'ttHLepAnalyzerDebug',
    rhoMuon= 'kt6PFJetsCentralNeutral',
    rhoElectron = 'kt6PFJets',
    muons='cmgMuonSel',
